...
void Adafruit_BMP085::begin(uint8_t mode) {
  ...
  Serial.print("ac1 = "); Serial.println(ac1, HEX);
  Serial.print("ac2 = "); Serial.println(ac2, HEX);
  Serial.print("ac3 = "); Serial.println(ac3, HEX);
  Serial.print("ac4 = "); Serial.println(ac4, HEX);
  Serial.print("ac5 = "); Serial.println(ac5, HEX);
  Serial.print("ac6 = "); Serial.println(ac6, HEX);

  Serial.print("b1 = "); Serial.println(b1, HEX);
  Serial.print("b2 = "); Serial.println(b2, HEX);

  Serial.print("mb = "); Serial.println(mb, HEX);
  Serial.print("mc = "); Serial.println(mc, HEX);
  Serial.print("md = "); Serial.println(md, HEX);
#endif
}
